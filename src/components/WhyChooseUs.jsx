...
export default function WhyChooseUs() {
  return (
    <section className="py-16 flex flex-col items-center sm:px-0 px-2">
  <div className="text-center w-full sm:w-3/4">
    ...
    <p className="text-lg sm:w-2/3 mx-auto text-left sm:text-center">
  ...
  <div className="mt-12 flex flex-wrap justify-center gap-6 sm:gap-4 w-full md:w-full ">
    ...
    >
      <div className="flex items-end space-x-4">
        ...
        <h3 className="text-xl font-semibold text-gray-800">POUZDANOST</h3>
      </div>
      <p className="mt-2 text-gray-600">
    ...
    >
      <div className="flex items-end space-x-4">
        ...
        <h3 className="text-xl font-semibold text-gray-800">FLEKSIBILNOST</h3>
      </div>
      <p className="mt-2 text-gray-600">
